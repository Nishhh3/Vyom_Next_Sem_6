        ...
        <div className="relative max-w-7xl mx-auto">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-xl text-slate-400 mb-10 leading-relaxed max-w-2xl mx-auto">
              Experience the future of finance with AI-driven insights, multi-bank integration, 
              and military-grade blockchain security—all in one seamless platform.
            </p>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="bg-slate-800/50 backdrop-blur border border-slate-700/50 rounded-2xl p-8 hover:border-red-600/50 transition-all group">
              ...
              <p className="text-slate-400 leading-relaxed">
                Military-grade encryption and blockchain technology ensure your transactions are always secure
              </p>
            </div>
